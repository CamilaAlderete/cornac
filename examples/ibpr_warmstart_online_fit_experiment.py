...
def filter_to_base_known(base_raw, adapt_raw, test_raw):
    """Remove users/items unseen in base to focus the experiment on warm-start adaptation."""
...
def build_datasets(base_raw, adapt_raw, test_raw):
    """Build Cornac datasets with a shared global mapping for stable warm-start U/V transfer."""
