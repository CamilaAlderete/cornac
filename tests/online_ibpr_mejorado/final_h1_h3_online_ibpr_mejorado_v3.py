...
def primary_eval_rows_for_step(known_chunks, step_idx):
    ...
    primary_rows = [row for row in allwarm_eval_rows if row[0] in updated_users]
    if not primary_rows:
        raise ValueError(
        ...
        plan.append(
            {
                ...
                "n_allwarm_unadapted_users": len(allwarm_users - updated_users),
...
def print_plan(data, protocol_hash):
    ...
    for item in data["primary_eval_plan"]:
        print(
            ...
            f"updated_users={item['n_updated_users']:,} | "
...
def run_seed_trial(seed, data, protocol_hash):
    ...
    for step_idx in range(3):
        ...
        eval_rows, allwarm_eval_rows, updated_users = primary_eval_rows_for_step(
        ...
        row = {
            ...
            "n_allwarm_eval_unadapted_users": len(
                {r[0] for r in allwarm_eval_rows} - updated_users
            ),
